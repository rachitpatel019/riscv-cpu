...
vlog -sv \
    ...
    ../rtl/4_memory/mmio_controller.sv \
    ../rtl/4_memory/system_interconnect.sv \
    ...
    ../rtl/hazard_handling/memory_arbiter.sv \
    ../rtl/core.sv \
    ../rtl/dual_core_top.sv \
    ../tb/dual_core_top_tb.sv

# Run simulation
vsim -c -voptargs=+acc work.dual_core_top_tb
run -all
quit -sim
quit -f
