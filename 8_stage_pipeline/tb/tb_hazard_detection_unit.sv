...
module tb_hazard_detection_unit;
    ...
    initial begin
        ...
        drive_hazard(5'd1, 5'd2, 1, 1, 0, 0, 0, 0, 1, 5'd2, 0, 0); check_hazard(1);
        
        // 5. Stage 7 (EX3) Load-Use Hazard
        drive_hazard(5'd1, 5'd2, 1, 1, 0, 0, 0, 0, 0, 0, 1, 5'd1); check_hazard(1);

        // 6. Uses RS2 Filter
        drive_hazard(5'd1, 5'd2, 1, 0, 1, 5'd2, 0, 0, 0, 0, 0, 0); check_hazard(0);

        // 7. Uses RS1 Filter
        drive_hazard(5'd1, 5'd2, 0, 1, 1, 5'd1, 0, 0, 0, 0, 0, 0); check_hazard(0);

        // 8. R0 Exemption
        drive_hazard(5'd0, 5'd0, 1, 1, 1, 5'd0, 0, 0, 0, 0, 0, 0); check_hazard(0);
