# run_benchmark.do
# ModelSim run script for the 8-stage balanced pipeline benchmark simulation
...
vlog -work work tb_benchmark.sv

# Load simulation
vsim -voptargs="+acc" -onfinish exit work.tb_benchmark
