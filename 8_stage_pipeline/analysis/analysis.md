...
| **Logic Utilization** | **2,768 / 49,760 LEs** (6%) | [cpu.fit.summary](../fpga/output_files/cpu.fit.summary) |
| **Register Usage** | **1,352 registers** | [cpu.fit.summary](../fpga/output_files/cpu.fit.summary) |
| **BRAM Usage** | **1,052,672 bits** (63% capacity) | [cpu.fit.summary](../fpga/output_files/cpu.fit.summary) |
| **Static Power** | **97.23 mW** | [cpu.pow.summary](../fpga/output_files/cpu.pow.summary) |
| **Dynamic Power** | **223.81 mW** | [cpu.pow.summary](../fpga/output_files/cpu.pow.summary) |
| **Total Power** | **329.99 mW** | [cpu.pow.summary](../fpga/output_files/cpu.pow.summary) |
...
| :--- | :--- | :--- |
| **Total Execution Cycles** | **98,269 cycles** | [tb_benchmark.sv](tb_benchmark.sv) |
| **Instructions Retired** | **41,752 instructions** | [tb_benchmark.sv](tb_benchmark.sv) |
| **CPI (Cycles Per Instruction)** | **2.3536** | $\text{Total Cycles} / \text{Instructions Retired}$ |
| **IPC (Instructions Per Cycle)** | **0.4249** | $1 / \text{CPI}$ |
| **MIPS (Millions of Inst/Sec)** | **53.11 MIPS** | $125.0\text{ MHz} \times \text{IPC}$ |
...
| **Total Stall Cycles** | **49,044 cycles** (49.91%) | [hazard_detection_unit.sv](../rtl/core/hazard_control/hazard_detection_unit.sv) |
...
*   **ALU Back-to-Back (2-cycle stall):** 12,670 cycles ($6,335\text{ hazards} \times 2$)
*   **ALU 1-Instruction Gap (1-cycle stall):** 1,472 cycles ($1,472\text{ hazards} \times 1$)
...
*   **Unclassified Stalls (Store/Branch/Jump dependencies):** 6,003 cycles
...
| Metric | Value | Reference / Formula |
| :--- | :--- | :--- |
| **Energy Per Instruction (EPI)** | **6.213 nJ/instruction** | $(\text{Total Power} \times \text{Execution Time}) / \text{Instructions Retired}$ |
| **Performance Per Watt** | **1.6094 × 10⁸ instructions/Joule** | $\text{Instructions Retired} / \text{Total Energy}$ |
| **MIPS/Watt** | **160.94 MIPS/W** | $\text{MIPS} / \text{Total Power (W)}$ |
| **Area Efficiency** | **19.19 KIPS/LE** | $53.11\text{ MIPS} / 2,768\text{ LEs}$ (or $1.535 \times 10^{-4}\text{ IPC/LE}$) |
