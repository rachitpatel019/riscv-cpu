...
verify_file ../../tb/tb_branch_predictor.sv
...
vlib work
vmap work work
vlog -sv ../../packages/alu_pkg.sv ../../packages/decoder_pkg.sv ../../rtl/core/4_reg_read/bht.sv ../../rtl/core/4_reg_read/branch_predictor.sv ../../tb/tb_branch_predictor.sv
vsim -batch -L work -voptargs=+acc work.tb_branch_predictor
run -all
