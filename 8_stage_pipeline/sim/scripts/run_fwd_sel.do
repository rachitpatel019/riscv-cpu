...
vlib work
vmap work work
vlog -sv ../../packages/alu_pkg.sv ../../packages/decoder_pkg.sv ../../rtl/core/7_ex3_mem/fwd_sel.sv ../../tb/tb_fwd_sel.sv
vsim -batch -L work -voptargs=+acc work.tb_fwd_sel
run -all
